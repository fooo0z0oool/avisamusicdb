 ...
 * @since  1.0.0
 */
class AvisamusicdbModelAlbum extends AdminModel
{
	 ...
	 * @return JTable
	 */
	public function getTable($name = 'Album', $prefix = 'AvisamusicdbTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_avisamusicdb.album', 'album', array('control' => 'jform', 'load_data' => $loadData));
	...
	public function loadFormData()
	{
		$data = Factory::getApplication()
			->getUserState('com_avisamusicdb.edit.album.data', array());
