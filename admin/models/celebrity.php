 ...
 * @since  1.0.0
 */
class AvisamusicdbModelCelebrity extends AdminModel
{
	 ...
	 * @return JTable
	 */
	public function getTable($name = 'Celebrity', $prefix = 'AvisamusicdbTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_avisamusicdb.celebrity', 'celebrity', array('control' => 'jform', 'load_data' => $loadData));
	...
	public function loadFormData()
	{
		$data = Factory::getApplication()
			->getUserState('com_avisamusicdb.edit.celebrity.data', array());
