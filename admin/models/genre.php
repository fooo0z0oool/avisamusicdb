 ...
 * @since  1.0.0
 */
class AvisamusicdbModelGenre extends AdminModel
{
	 ...
	 * @return JTable
	 */
	public function getTable($name = 'Genre', $prefix = 'AvisamusicdbTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_avisamusicdb.genre', 'genre', array('control' => 'jform', 'load_data' => $loadData));
	...
	public function loadFormData()
	{
		$data = Factory::getApplication()
			->getUserState('com_avisamusicdb.edit.genre.data', array());
