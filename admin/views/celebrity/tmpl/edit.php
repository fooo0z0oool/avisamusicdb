...
<form action="<?php echo Route::_('index.php?option=com_avisamusicdb&view=celebrity&layout=edit&id=' . (int) $this->item->id); ?>" name="adminForm" id="adminForm" method="post" class="form-validate">
	<?php if (JVERSION < 4 && !empty($this->sidebar)) { ?>
		...
		<div class="form-horizontal">
			<div class="<?php echo $rowClass; ?>">
				<div class="<?php echo $colClass; ?>12">
					...
					<?php echo HTMLHelper::_("$tab.addTab", 'myTab', 'personal_info', Text::_('COM_AVISAMUSICDB_FIELDSET_PERSONAL_INFO')); ?>
					<?php echo $this->form->renderFieldset('personal_info'); ?>
					<?php echo HTMLHelper::_("$tab.endTab"); ?>

					<?php echo HTMLHelper::_("$tab.addTab", 'myTab', 'actior_links', Text::_('COM_AVISAMUSICDB_FIELDSET_CELEBRITY_LINKS')); ?>
					<?php echo $this->form->renderFieldset('actior_links'); ?>
					<?php echo HTMLHelper::_("$tab.endTab"); ?>
		...
		<input type="hidden" name="task" value="celebrity.edit" />
