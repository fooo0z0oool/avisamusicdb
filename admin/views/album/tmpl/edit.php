...
<form action="<?php echo Route::_('index.php?option=com_avisamusicdb&view=album&layout=edit&id=' . (int) $this->item->id); ?>" name="adminForm" id="adminForm" method="post" class="form-validate">
		...
		<div class="form-horizontal">
			<div class="<?php echo $rowClass; ?>">
				<div class="<?php echo $colClass; ?>12">
					...
					<?php echo HTMLHelper::_("$tab.addTab", 'myTab', 'actior_links', Text::_('COM_AVISAMUSICDB_FIELDSET_ALBUM_LINKS')); ?>
					<?php echo $this->form->renderFieldset('album_links'); ?>
					<?php echo HTMLHelper::_("$tab.endTab"); ?>
