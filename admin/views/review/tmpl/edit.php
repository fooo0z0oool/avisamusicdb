...
<form action="<?php echo Route::_('index.php?option=com_avisamusicdb&view=review&layout=edit&id=' . (int) $this->item->id); ?>" name="adminForm" id="adminForm" method="post" class="form-validate">
		...
		<div class="form-horizontal">
			<div class="<?php echo $rowClass; ?>">
				<div class="<?php echo $colClass; ?>12">
					...
					<?php echo HTMLHelper::_("$tab.addTab", 'myTab', 'basic', Text::_('JDETAILS')); ?>
