...
<div id="avisamusicdb" class="avisamusicdb view-avisamusicdb-celebrity">

    <!-- celebrity cover -->
    <div class="celebrity-cover" style="background-image: url(<?php echo Uri::root() . $this->item->cover_image; ?>); ">
    ...
    <div class="celebrity-details-wrap">
        <div class="avisamusicdb-container">
            <div class="avisamusicdb-row">
                <div id="celebrity-info-sidebar" class="avisamusicdb-col-sm-3 celebrity-info-sidebar">
                    <div class="img-wrap">
                        <div class="item-img">
                            <img src="<?php echo Uri::root() . $this->item->profile_image; ?>" alt="">
                        </div>
                        <div class="avisamusicdb-details-wrapper">
                            <h3 class="title"><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_PERSONAL_INFO'); ?></h3>
                            <ul class="list-style-none list-inline">
                                <?php if (isset($this->item->birth_name) && $this->item->birth_name) { ?>
                                    <li>
                                        <span><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_BIRTHNAME'); ?>: </span>
                                        <?php echo $this->item->birth_name; ?>
                                    </li>
                                <?php }
                                if (isset($this->item->dob) && $this->item->dob) { ?>
                                    <li>
                                        <span><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_DOB'); ?>: </span>
                                        <?php echo HTMLHelper::date($this->item->dob, 'd, M Y'); ?>
                                    </li>
                                <?php }
                                if (isset($this->item->residence) && $this->item->residence) { ?>
                                    <li>
                                        <span><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_RESIDENCE'); ?>: </span>
                                        <?php echo $this->item->residence; ?>
                                    </li>
                                <?php }
                                if (isset($this->item->height) && $this->item->height) { ?>
                                    <li>
                                        <span><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_HEIGHT'); ?>: </span>
                ...
                <div class="avisamusicdb-col-sm-9 celebrity-info-warpper">

                    <!-- celebrity-details -->
                    <div class="celebrity-details">
                        <div class="header-title">
                            <span><i class="avisamusicdb-icon-story"></i></span>
                            <h3 class="title"><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_BIOGRAPHY'); ?></h3>
                        </div>
                        <?php echo $this->item->biography; ?>

                    </div> <!-- //celebrity-details -->

                    <?php if (isset($this->item->celebrity_musics) && (count($this->item->celebrity_musics) > 0) && $this->item->celebrity_musics) { ?>
                        <!-- Filmography -->
                        <div class="avisamusicdb-filmography col-sm-12">
                            <div class="header-title">
                                <span><i class="avisamusicdb-icon-film"></i></span>
                                <h3 class="title"><?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_FILMOGRAPHY'); ?></h3>
                            </div> <!-- //header-title -->
                            ...
                            <ul class="list-unstyled avisamusicdb-film-list">
                                ...
                                <?php foreach ($this->item->celebrity_musics as $c_music) { ?>
                                    <li calss="music-list">
                                        <div class="details pull-left">
                                            ...
                                            <div>
                                                ...
                                                <p class="celebrity-music-genres">
                                                    <?php
                    ...
                    <?php if (isset($this->item->actor_trailers) && (count($this->item->actor_trailers) > 0) && $this->item->actor_trailers) { ?>
                        ...
                        <div class="trailers-videos">
                            <div class="header-title pull-left">
                                ...
                                <h3 class="title">
                                    <?php echo Text::_('COM_AVISAMUSICDB_CELEBRITY_TRAILERS_AND_VIDEOS'); ?>
                                </h3>
                            </div>
