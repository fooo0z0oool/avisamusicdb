...
$allAlphaUrl = 'index.php?option=com_avisamusicdb&view=albums&Itemid=' . $Itemid;

if ($alphaindex) {
    $alphaUrl = 'index.php?option=com_avisamusicdb&view=albums&alphaindex=' . $alphaindex . '&Itemid=' . $Itemid;
} else {
    $alphaUrl = 'index.php?option=com_avisamusicdb&view=albums&Itemid=' . $Itemid;
}

?>

<div id="com-avisa-musicdb" class="avisamusicdb avisa-musicdb avisa-musicdb-view-albums">
    ...
    <div class="musicdb-filters">
        ...
        <div class="pull-right">
            ...
            <strong><?php echo $this->total_albums; ?></strong>
        </div>
    </div>
